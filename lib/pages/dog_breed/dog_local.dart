// ignore_for_file: unnecessary_string_interpolations, prefer_final_fields, deprecated_member_use, prefer_const_constructors
...
class DogLocal extends StatefulWidget {
  const DogLocal({Key? key}) : super(key: key);

  @override
  _DogLocalState createState() => _DogLocalState();
}

class _DogLocalState extends State<DogLocal> {
